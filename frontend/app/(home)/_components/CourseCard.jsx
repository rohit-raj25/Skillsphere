...
const CourseCard = ({ course }) => {
  return (
    <>
      <div
        className="   ml-10 mt-7 border-none   rounded  h-80 w-80 "
        data-tip="hello"
      >
        ...
        <div className="px-2 py-0  font-bold flex gap-1">
          <span className="text-l bg-center">{course.ratings}</span>
        ...
        <div className="px-2 py-0  font-bold flex ">
          ...
          <span className="text-xl bg-center ml-0">${course.price}</span>
